...
pg2b3dm -h pg_db -U magic -c geom_triangle -t batiment_buff -d magic -a id,hauteur_shrunk,nature,usage1,usage2 --use_implicit_tiling 'false' --default_color '#b7b9bd' --add_outlines 'true' --boundingvolume_heights 0,3000 
